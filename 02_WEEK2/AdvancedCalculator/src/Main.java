...
public class Main {
    ...
    static void mod(){
        Scanner scan= new Scanner(System.in);
        System.out.println("Hangi sayının modülü alınsın?: ");
        int number1= scan.nextInt();
        System.out.println("Hangi sayıya göre modül alınsın?: ");
    ...
    static void rectangleAreaAndPerimeter(){
        ...
        System.out.println("Alanı : " +side1*side2);
        System.out.println("Çevresi: " + (side1+side2)*2);
